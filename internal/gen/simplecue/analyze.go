...
func getKindFor(v cue.Value) (ASTTarget, error) {
	...
	return ASTTarget(tt), nil
}

func getKindForField(v cue.Value) (ASTTarget, bool) {
...
func iterateField(s *ast.StructLit) (ASTTarget, bool) {
...
func parseStringAttribute(attr string) ASTTarget {
	switch attr {
...
func targetsKind(v cue.Value, kinds ...ASTTarget) bool {
...
func containsCuetsyReference(v cue.Value, kinds ...ASTTarget) bool {
...
func hasOverrideValues(v cue.Value, kinds ...ASTTarget) bool {
...
func findRefWithKind(v cue.Value, kinds ...ASTTarget) (ref, referrer cue.Value, has bool) {
	xt := exprTree(v)

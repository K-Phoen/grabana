...
type Dashboard struct {
	...
	Style disjunction<string | string> `json:"style"`
	...
	Refresh disjunction<string | bool> `json:"refresh,omitempty"`
...
type VariableModel struct {
	...
	Description string `json:"description,omitempty"`
	Query disjunction<string | any> `json:"query,omitempty"`
...
type VariableOption struct {
	...
	Text disjunction<string | []string> `json:"text"`
	Value disjunction<string | []string> `json:"value"`
}
...
type Panel struct {
	...
	RepeatDirection disjunction<string | string> `json:"repeatDirection,omitempty"`
